...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        btnAdd.Location = New Point(1, 246)
        btnAdd.Name = "btnAdd"
        ...
        btnUpdate.Location = New Point(1, 302)
        ...
        btnDelete.Location = New Point(259, 246)
        ...
        btnClear.Location = New Point(259, 302)
        ...
        Label1.Font = New Font("Verdana", 14.25F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        ...
        Label2.Font = New Font("Verdana", 14.25F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        ...
        Label3.Font = New Font("Verdana", 12F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        Label3.Location = New Point(1, 133)
        Label3.Name = "Label3"
        ...
        Label4.Font = New Font("Verdana", 14.25F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        ...
        ' dgvBooks
        ' 
        dgvBooks.BackgroundColor = Color.Aqua
        ...
        Label5.Font = New Font("Verdana", 14.25F, FontStyle.Bold Or FontStyle.Italic, GraphicsUnit.Point, CByte(0))
        Label5.ForeColor = Color.Black
        Label5.Location = New Point(136, 11)
        Label5.Name = "Label5"
        Label5.Size = New Size(357, 23)
        Label5.TabIndex = 14
